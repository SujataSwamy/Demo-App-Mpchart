...
public class ChartValueAdapter2 extends RecyclerView.Adapter<ChartValueAdapter2.MyViewHolder> {

    private  AdapterCallback2 mAdapterCallback;
    private ArrayList<SelectorModel> modelList;
    private Context mContext;

    public ChartValueAdapter2(ArrayList<SelectorModel> model, Context fragment) {
        mContext = fragment;
        this.modelList = model;

        try {
            this.mAdapterCallback = ((AdapterCallback2) fragment);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            indicator = view.findViewById(R.id.view);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_chart_2, parent, false);
    ...
    public static interface AdapterCallback2 {
